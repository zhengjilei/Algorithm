 ...
 */
public class Q0703_KthLargest {


    int[] heap;
    int count;

    public Q0703_KthLargest() {

    }

    public Q0703_KthLargest(int k, int[] nums) {
        this.heap = new int[k];
    ...
    public static void main(String[] a) {
        ...
        Q0703_KthLargest m = new Q0703_KthLargest(7, new int[]{-10, 1, 3, 1, 4, 10, 3, 9, 4, 5, 1});
